				...
				<div className="max-w-4xl mx-auto px-4 text-center">
					...
					<form onSubmit={handleSubmit} className={`relative bg-slate-50 p-8 rounded-3xl shadow-sm border max-w-md mx-auto text-left transition-colors duration-500 ${isDiscountActive ? 'border-green-400 shadow-xl shadow-green-100' : 'border-slate-100'}`}>
						...
						<div className="mb-4">
							...
							<input required type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+91 6303368552" className="w-full dark:text-white text-slate-900 px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none" />
						</div>
			...
			<footer className="bg-slate-900 text-slate-300 py-12">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
					...
					<div className="flex space-x-6 text-sm items-center">
						...
						<a href="tel:+916303368552" className="hover:text-white transition font-semibold text-lg border-l border-slate-700 pl-6">
                            Contact: +916303368552
                        </a>
					</div>
				</div>
